...
export default function Barra() {
    ...
    <div>
        <div>
            <Breadcrumb className="BarraNavegacion">
                <BreadcrumbItem>
                   <Link className="link" to={'/'}>Biblioteca</Link>
                </BreadcrumbItem>

                <BreadcrumbItem>
                    <Link className="link" to={'/'}>Mesa de entrada</Link>
                </BreadcrumbItem>

                <BreadcrumbItem>
                    <Link className="link" to={'/'}>Estudiantes</Link>
                </BreadcrumbItem>
                <BreadcrumbItem>
                    <Link className="link" to={'/'}>Profesores</Link>
                </BreadcrumbItem>
                <BreadcrumbItem>
        ...
        <div className="tituloTabla">
            <div className="cajaFoto">
                <img className="fotoUtn" src='https://enief2019.amcaonline.org.ar/images/partners/UTNParana.png' />
            </div>
            <div className="titulo">
                <h1 className="TituloUtn">
        ...
        <div className="botonesss">
            <button className="botonMenu"><Link className="link" to={'/Mesas'}>Lista mesas</Link></button>
            <button className="botonMenu"><Link className="link" to={'/Mesas/AgregarMesa'}>Agregar mesa</Link></button>
            <button className="botonMenu"><Link className="link" to={'/Alumnos'}>Lista alumnos</Link></button>
            <button className="botonMenu"><Link className="link" to={'/Alumnos/AgregarAlumno'}>Agregar alumno</Link></button>
            <button className="botonMenu"><Link className="link" to={'/'}>Mas +</Link></button>
        </div>
    </div>
    )
}